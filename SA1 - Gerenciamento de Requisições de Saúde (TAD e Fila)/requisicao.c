 ...
 * Complexidade: O(1) — operacoes de copia de string de tamanho fixo.
 * ---------------------------------------------------------- */
                             ...
                             const char *codigo_procedimento)
{
    ...
    /* strncpy garante que nao ultrapassamos o limite do buffer;
       forcamos o terminador nulo por seguranca.                */
